    ...
    <section className="py-12 lg:py-24">
      <div className="container mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <div className="h2 mb-3">How Big Your Dog Is ?</div>
          ...
          {bundleData.map((item, idx) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="lg:text-2xl capitalize font-semibold text-bluelg:mb-2">
                  {name}
                </h3>
                {/* category text */}
                <div
                  className={`${
                    index === idx
                      ? "border-b-4 border-orange transition-all after:lg:w-5 after:h-5 after:bg-triangle after:lg:bg-no-repeat after:lg:block after:lg:left-[130px] after:lg:absolute after:lg:-bottom-6 relative"
